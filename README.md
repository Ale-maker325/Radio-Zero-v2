...
Плата на базе ESP32S3 Zero и LoRa-модемов Ebyte Exx-400MxxS (SX12xx), разработанная для интеграции с [Meshtastic](https://github.com/Ale-maker325/ESP32_S3_33_433MHz_SX1278/wiki/Meshtastic) и ExpressLRS. Поддерживает передачу данных по технологии LoRa, подходит для создания mesh-сетей, телеметрии и экспериментов с беспроводной связью.
